...
const HomeStyle = () => {
  ...
  return (
    <BannerContainer>
      <Heading>Homes to Match Every Style</Heading>
      <Typography>
      High-quality finishes, stylish designs, and premium modules at affordable prices.
      </Typography>
      <Slider {...settings}>
        <SlideContainer>
        ...
        <SlideContainer>
          <SlideImage src={Monochromatic} alt="Classic Indian Bedroom" />
